...
export const options = resolveOptions({
  features: {
  "standalone": false,
  "rootDir": "/Users/ojaswi/Ojaswi/projects/velora/apps/auth/"
},
  dirs: {
    pages: [".playground/pages", "pages", "../../layers/base/pages"],
    composables: [".playground/composables", ".playground/utils", "composables", "utils", "../../layers/base/composables", "../../layers/base/utils"],
    components: [".playground/components", "components", "../../layers/base/components"],
    componentsPrefixed: [],
    layouts: [".playground/layouts", "layouts", "../../layers/base/layouts"],
    plugins: [".playground/plugins", "plugins", "../../layers/base/plugins"],
    middleware: [".playground/middleware", "middleware", "../../layers/base/middleware"],
    modules: [".playground/modules", ".playground/modules", ".playground/modules"],
    servers: [],
    root: [],
    src: [".playground", "", "../../layers/base"],
}
})
